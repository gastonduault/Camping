...
public class FenetreSupr extends Stage {
	...
	private ObservableList<String> options = FXCollections.observableArrayList("Client","R�servation","Emplacement");
	private ObservableList<String> optionsTri = FXCollections.observableArrayList();
	private String [] triClient = {"Num�ro client","Date","Nom"};
	private String [] triReserv = {"Num�ro reserv","Prix","Date"};
	private String [] triEmplacement = {"Num�ro emp","Date"};
